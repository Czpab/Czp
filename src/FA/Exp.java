...
public class Exp {
    ...
    //随机生成一个分数
    public static FC fraction_create(int r) {
        ...
        return new FC( numerator , denominator );
    }

    //随机生成运算符
    public static char operator_create() {
    ...
    //生成表达式
    public static String getexp(int r) {
        String expression="";
    ...
    //一个运算符
    public static String oneopexp(int r) {
        FC f1=fraction_create(r);
        FC f2=fraction_create(r);
    ...
    //两个运算符
    public static String twoopexp(int r){
        FC f1=fraction_create(r);
        FC f2=fraction_create(r);
        FC f3=fraction_create(r);
    ...
    //三个运算符
    public static String threeopexp(int r){
        FC f1=fraction_create(r);
        FC f2=fraction_create(r);
        FC f3=fraction_create(r);
        FC f4=fraction_create(r);
