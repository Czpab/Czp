...
public class CL {
    ...
    //判断是否是数字
    public static boolean isfra(char c) {
        if(c>='0'&&c<='9')
        {return true;}
        return false;
    }
    public static boolean isfraop(char c) {
        if(c=='\''||c=='/') {
            return true;
        }
        return false;
    ...
    //查重表达式的生成
    public static List<String> getcnki(String str){
        List<String> linfix=Stringtolist(str);
        List<String> lpostfix=infixtopostfix(linfix);
