...
public class Main {
    ...
    public static void main(String[] args) throws IOException  {
        ...
        System.out.println("四则运算题目生成程序");
        System.out.println("-r 题目中数值范围（该参数可以设置为1或其他自然数）");
        System.out.println("-n 题目的个数（该参数可以设置为1或其他自然数）");
        System.out.println("-e 需要批改答案的文件路径");
        System.out.println("-a 正确答案的文件路径");
        System.out.println("请按照下面的格式输入命令");
        System.out.println("例：-n 10 -r 10 或 -r 10 -n 10 (-r和-n命令需要一起使用)");
        System.out.println("例：-e C:\\\\Answer.txt -a C:\\\\Answers.txt (-e和-a命令需要一起使用)");
        while(scan.hasNextLine()) {
            ...
            if(c[0].equals("-n")&&c[2].equals("-r")) {
                ...
                create.cr(n,r);
                System.out.println("题目文件Exercises.txt和答案文件Answers.txt已生成，放置在本程序的当前目录下");
            }
            ...
            if(c[0].equals("-e")&&c[2].equals("-a")) {
                ...
                System.out.println("批改文件Grade.txt已生成，放置在当前本项目的目录下");
            }
